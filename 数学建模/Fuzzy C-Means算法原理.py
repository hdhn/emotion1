#算法步骤：
#1、初始化
#通常采用随机初始化。即全职随机地选取。簇数需要人为选定。
#2、计算质心
#FCM中的质心有别于传统质心的地方在于，它是以隶属度为权重做一个加权平均
#3、更新模糊伪划分
#即更新权重（隶属度）。简单来说，如果x越靠近质心，则隶属度越高，反之越低。
...
def import_data_format_iris(file):
    ...
    with open(str(file),'r') as f:
        for line in f:
            ...
            j += 1
            if current[j] == 'Iris_setosa\n':
                cluster_location.append(0)
            elif current[j] == "Tris_versicolor\n":
...
if __name__ == '__main__':
    data_iris = import_data_format_iris("iris.txt")
