...
degree_word = open_dict(Dict='程度副词', path=r'./')
mostdict = degree_word[degree_word.index('没错') + 1: degree_word.index('极力')]  # 权重4，即在情感词前乘以4
verydict = degree_word[degree_word.index('极力') + 1: degree_word.index('较')]  # 权重3
moredict = degree_word[degree_word.index('较') + 1: degree_word.index('越')]  # 权重2
ishdict = degree_word[degree_word.index('越') + 1: degree_word.index('不无')]  # 权重0.5
